...
const plans = [
  { id: "audit", name: "Audit", price: 399, copy: "A focused health check for your current cloud and delivery setup.", features: ["Infrastructure & CI/CD review", "Security and reliability checks", "Cost-saving opportunities", "Prioritized action plan"] },
  { id: "launch", name: "Launch", price: 899, copy: "For teams shipping their first reliable production stack.", featured: true, features: ["CI/CD pipeline setup", "Cloud infrastructure baseline", "Monitoring & alerts", "8 engineering hours / month"] },
];
const capabilities = [
